...
export class CreateTables21699769492254 implements MigrationInterface {
    name = 'CreateTables21699769492254'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "room_management" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "checkin" TIMESTAMP NOT NULL, "checkout" TIMESTAMP NOT NULL, "eletronic_key" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "guestId" uuid, "roomId" uuid, CONSTRAINT "PK_ad76949ce9501f820c47b062d12" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "room" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number_room" character varying NOT NULL, "status" character varying NOT NULL, "ocupationGuestId" uuid, CONSTRAINT "UQ_457e6bd694f3a85d8f2e07c9e1a" UNIQUE ("number_room"), CONSTRAINT "REL_28a0504ed59dea84996b233a65" UNIQUE ("ocupationGuestId"), CONSTRAINT "PK_c6d46db005d623e691b2fbcba23" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "guest" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(70) NOT NULL, "phone_number" character varying NOT NULL, "nationality" character varying NOT NULL, "emergency_contact" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "roomId" uuid, CONSTRAINT "REL_578347653e95fd3aef49b17c0d" UNIQUE ("roomId"), CONSTRAINT "PK_57689d19445de01737dbc458857" PRIMARY KEY ("id"))`);
